...
- Added testing dashboard `test-artifacts/TESTING_DASHBOARD_ITERATION.md` capturing JaCoCo summary and next actions.
...
- `test-artifacts/TESTING_DASHBOARD_ITERATION.md` — new dashboard summary (moved into `test-artifacts`).
- `test-artifacts/CHANGELOG_PR_BODY.md` — PR body (this file).
